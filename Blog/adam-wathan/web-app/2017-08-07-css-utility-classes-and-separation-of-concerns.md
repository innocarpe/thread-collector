...
Write the markup I needed for some new UI _(an author bio card in this case)_:
...
Add a descriptive class or two based on the content:
...
Use those classes as "hooks" in my CSS/Less/Sass to style my new markup:
...
~~_"Separation of Concerns"_~~ **CSS that depends on HTML.**
...
~~_"Mixing Concerns"_~~ **HTML that depends on CSS.**
